...
public final class ArbitrageTopology {
    ...
    public static void apply(StreamsBuilder builder, AggoraConfig props, AvroSerdes serdes) {
        AggoraConfig.Arbitrage config = props.arbitrage();
    ...
    private static ArbitrageSpread spread(AggoraConfig.Arbitrage config,
    ...
    static Duration joinWindow(AggoraConfig props) {
